...
from auth_data import username, password # подключаем одельный фал с логинам и паролям
...
class InstagramBot():
    ...
    def __init__(self, username, password):
        ...
        self.browser = webdriver.Chrome("/media/6AEB14D3AE0B9A01/PyCharm/Selenium/Instagram_bot/chromedriver")
...
my_bot.login()
my_bot.put_many_likes("https://www.instagram.com/resnichka_style/")
